...
const DriftWall = ({
  ...
  const renderTile = (item, id, colIndex) => {
      ...
      <span className="drift-wall__inner">
        <img
          ...
          style={{
            ...
            objectPosition: item.orientation === 'portrait' ? 'center' : 'center center',
          }}
        />
    ...
    const commonProps = {
      className: `drift-wall__tile${activeId === id ? ' is-active' : ''}${item.orientation ? ` drift-wall__tile--${item.orientation}` : ''}`,
      'data-tile-id': id,
      'data-col': colIndex,
